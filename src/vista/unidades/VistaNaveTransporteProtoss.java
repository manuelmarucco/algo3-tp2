...
public class VistaNaveTransporteProtoss extends ImagePanel implements MouseListener {

    private static final int ANCHO = 1;
    private static final int ALTO = 2;
    private final NaveTransporteProtoss unidad;

    public VistaNaveTransporteProtoss(NaveTransporteProtoss nave/*TODO aca se pasa el panel del juego*/) {
