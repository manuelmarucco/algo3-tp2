...
public class ActuableTest {
    ...
    public void testAtacarAereo(){
        ...
        Unidad objetivo = new Unidad("marine",new Vida(10),1, new Aereo(),new UnidadGuerrera(new Danio(1,1,1,0)),new Costo(10,10),1);
    ...
    public void testAtacarTerrestre(){
        Actuable atacar = new AccionAtacar(new Danio(1,2,1,0));
        Unidad objetivo = new Unidad("marine",new Vida(10),1, new Terrestre(),new UnidadGuerrera(new Danio(1,1,1,0)),new Costo(10,10),1);
        atacar.actuar(objetivo);
